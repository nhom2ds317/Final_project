...
df_org = pd.read_csv("demo/daxuly.csv")
df_org = df_org.rename(columns={'label': 'xeploai'})
df_y1 = pd.read_csv('demo/test_data_for_demo_year1.csv')
df_y2 = pd.read_csv('demo/test_data_for_demo_year2.csv')
df_y3 = pd.read_csv('demo/test_data_for_demo_year3.csv')
df_y35 = pd.read_csv('demo/test_data_for_demo_year35.csv')
...
with open("demo/model_cb_sm_y1.pkl", "rb") as file:
    model_y1 = pickle.load(file)
with open("demo/model_xg_ts_y2.pkl", "rb") as file:
    model_y2 = pickle.load(file)
with open("demo/model_xg_ts_y3.pkl", "rb") as file:
    model_y3 = pickle.load(file)
with open("demo/model_lgb_ts_y35.pkl", "rb") as file:
...
if statistic_all:
    with st.sidebar:
        ...
        radio1 = st.radio('Mời bạn chọn phạm vi tra cứu:', ['Toàn trường', 'Theo khoa', 'Sinh viên cụ thể'])
...
if predict_all:
    with st.sidebar:
        ...
        #st.write('Mời bạn chọn phạm vi tra cứu:')
        radio2 = st.radio('Mời bạn chọn phạm vi tra cứu:', ['Tổng quát', 'Sinh viên cụ thể'])
